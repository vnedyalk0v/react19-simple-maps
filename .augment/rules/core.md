...
- Prefer function components, use class components only for error boundaries, follow the existing `ref`-as-prop pattern, and memoize expensive geography work.
